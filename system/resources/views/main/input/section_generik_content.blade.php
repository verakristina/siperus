...
<td style="width:1%;white-space:nowrap;">
	...
	<a href="{{asset('input/hapus/'.$type.'/'.$val->r_bio_id)}}" onclick="return confirm('Apakah anda yakin ingin menhapus data ini?');" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><i class="fa fa-trash"></i></a>
