...
@section('title-page','Form Pendaftaran')
...
<div class="content-wrapper min-height" style="min-height:1px;width:100%;margin:0px !important;">
						...
						<div class="nav-tabs-custom tab-custom" style="box-shadow: 0 0 0 rgba(0,0,0,0);">
							...
							<div class="tab-content">
								<div class="active tab-pane" id="biodata">
									@include('register.form.tabs-biodata')
								</div>
